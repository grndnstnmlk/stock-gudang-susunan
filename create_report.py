...
blocks_data = {
    1: {
        "title": "BLOK 01",
        "headers": ["Saf -5", "Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 0", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     "",     "",     "",     942, 947, 941, 955, 952, 948], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     945, 950, 949, 954, 951, 953], # T7
            [1552,   "",     "",     "",     1551,   "",     643, 640, 647, 637, 638, 644], # T6
            [1556,   1581,   1565,   1491,   1451,   "",     24,  182, 132, 635, 636, 639], # T5
            [1474,   1471,   1476,   1427,   1396,   "",     305, 18,  520, 144, 234, 274], # T4
            [116,    900,    864,    620,    1363,   1566,   508, 214, 460, 462, 516, 123], # T3
            [901,    926,    923,    318,    915,    1409,   283, 23,  467, 509, 177, 193], # T2
            [107,    594,    859,    865,    914,    1333,   494, 497, 453, 474, "",  310], # T1 (Dasar)
        ]
    },
    2: {
        "title": "BLOK 02",
        "headers": ["Saf -5", "Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 0", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     "",     "",     "",     929, "",  958, 956, 940, 946], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     961, 962, 960, 957, 944, 943], # T7
            ["",     1294,   1351,   "",     "",     "",     634, 631, 646, 648, 645, 602], # T6
            [1574,   1545,   1484,   "",     1548,   "",     289, 633, 649, 641, 601, 642], # T5
            [1397,   1393,   1452,   1400,   1470,   "",     125, 444, 158, 448, 108, 112], # T4
            [932,    924,    631,    920,    1355,   1401,   493, 439, 438, 511, 171, 124], # T3
            [902,    919,    703,    916,    912,    1426,   183, 368, 464, 491, 469, 504], # T2
            [927,    928,    593,    871,    899,    1374,   164, 288, 510, 227, 416, 99 ], # T1 (Dasar)
        ]
    },
    3: {
        "title": "BLOK 03",
        "headers": ["Saf -5", "Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 0", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     "",     "",     "",     986, 981, 867, 911, 826, 830], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     907, 905, 903, 904, 964, 963], # T7
            [1605,   "",     "",     "",     "",     "",     625, 608, 627, 628, 652, 661], # T6
            [1572,   "",     "",     1608,   1490,   "",     632, 626, 629, 630, 657, 655], # T5
            [1460,   1429,   1536,   1414,   1445,   "",     230, 199, 503, 495, 32,  437], # T4
            ["",     1415,   1421,   1354,   1358,   "",     937, 936, 934, 456, 282, 91 ], # T3
            [913,    933,    939,    935,    922,    1456,   222, 217, 502, 440, 487, "" ], # T2
            [929,    590,    925,    938,    918,    1346,   408, 465, 296, 421, 463, 206], # T1 (Dasar)
        ]
    },
    4: {
        "title": "BLOK 04",
        "headers": ["Saf -5", "Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 0", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     "",     "",     "",     985, 984, 878, 970, 971, 976], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     987, 980, 979, 973, 972, 975], # T7
            ["",     "",     "",     "",     "",     "",     656, 658, 659, 653, 651, 650], # T6
            ["",     "",     "",     "",     "",     "",     660, 662, 665, 654, 605, 506], # T5
            ["",     1328,   1408,   "",     "",     "",     225, 471, 313, 228, 221, 149], # T4
            [1510,   1436,   1399,   1417,   1446,   "",     166, 466, 178, 215, 307, 309], # T3
            [1307,   1289,   1303,   1316,   1365,   1407,   279, 451, 442, 513, 461, 459], # T2
            [1287,   1272,   1261,   1266,   1267,   1360,   304, 452, 458, 450, 449, 496], # T1 (Dasar)
        ]
    },
    5: {
        "title": "BLOK 05",
        ...
        "data": [
            ["",     "",     "",     "",     "",     "",     "",  "",  "",  982, 983, 977], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     "",  "",  "",  666, 968, 969], # T7
            ["",     "",     "",     "",     "",     "",     674, 675, 676, 677, 678, 679], # T6
            [1369,   "",     "",     "",     "",     "",     663, 673, 671, 667, 666, 664], # T5
            [1482,   "",     "",     "",     1493,   "",     207, 213, 308, 519, 436, 457], # T4
            [1422,   1416,   1437,   1439,   1413,   "",     146, 224, 226, 489, 485, 490], # T3
            [1386,   1315,   1331,   1305,   1308,   1411,   284, 216, 219, 498, 430, 472], # T2
            [1273,   1269,   1263,   1262,   1268,   1309,   306, 229, 218, 454, 455, 486], # T1 (Dasar)
        ]
    },
    6: {
        "title": "BLOK 06",
        ...
        "data": [
            ["",     "",     "",     "",     "",     "",     "",     1398,   "",     "",     "",     ""   ], # T8 (Atas)
            [1404,   1509,   "",     "",     "",     "",     1485,   1380,   1299,   "",     "",     ""   ], # T7
            [1653,   1607,   1511,   1530,   "",     "",     1382,   1394,   1478,   1505,   "",     ""   ], # T6
            [1583,   1313,   1537,   1555,   "",     1550,   1459,   1513,   1516,   1504,   1502,   1528 ], # T5
            [1477,   1476,   1333,   1487,   1457,   1580,   1379,   484,    492,    512,    983,    977  ], # T4
            [1314,   1311,   1423,   1454,   1361,   1486,   505,    501,    429,    500,    499,    517  ], # T3
            [1321,   1291,   1283,   1318,   1317,   1448,   476,    480,    479,    478,    477,    518  ], # T2
            [1271,   1260,   1270,   1258,   1259,   1319,   481,    482,    483,    475,    360,    447  ], # T1 (Dasar)
        ]
    },
    7: {
        "title": "BLOK 07",
        ...
        "data": [
            [1611,   "",     "",     "",     "",     "",     "",     1381,   "",     "",     "",     ""   ], # T8 (Atas)
            [1442,   1538,   "",     "",     "",     "",     "",     1295,   "",     "",     "",     ""   ], # T7
            [1544,   1570,   1554,   1582,   1535,   1512,   1384,   1387,   1290,   1515,   "",     ""   ], # T6
            [1453,   1479,   1495,   1488,   1573,   1653,   1373,   1395,   1264,   1523,   1527,   1526 ], # T5
            [1420,   1425,   1410,   1450,   1432,   1559,   1376,   1501,   1517,   1519,   1525,   1522 ], # T4
            [1366,   1364,   1359,   1362,   1370,   1489,   617,    593,    380,    350,    330,    329  ], # T3
            [1168,   1388,   1322,   1285,   1304,   1438,   619,    600,    377,    326,    339,    375  ], # T2
            [1171,   1282,   1275,   1280,   1152,   1293,   618,    589,    320,    384,    371,    352  ], # T1 (Dasar)
        ]
    },
    8: {
        "title": "BLOK 08",
        ...
        "data": [
            ...
            [1553,   "",     "",     "",     "",     "",     "",     "",     "",     "",     "",     ""   ], # T9
            [1568,   1561,   "",     "",     "",     "",     "",     "",     "",     "",     "",     ""   ], # T8
            [1541,   1557,   1441,   1312,   1585,   "",     1481,   1377,   "",     "",     "",     ""   ], # T7
            [1353,   1542,   1567,   1494,   1540,   "",     1378,   1372,   1306,   1531,   1498,   1520 ], # T6
            [1424,   1480,   1543,   1412,   1383,   1563,   1461,   1265,   1320,   1621,   1533,   1518 ], # T5
            [1352,   1433,   1492,   1455,   1447,   1560,   1386,   1341,   1532,   1499,   1507,   1503 ], # T4
            [1339,   1338,   1330,   1371,   1356,   1449,   "",     "",     "",     569,    "",     690  ], # T3
            [1281,   1092,   1126,   1216,   1284,   1352,   "",     585,    "",     "",     "",     ""   ], # T2
            [1274,   1279,   1278,   1276,   1277,   1292,   "",     "",     "",     "",     "",     ""   ], # T1 (Dasar)
        ]
    },
    9: {
        "title": "BLOK 09",
    ...
    10: {
        "title": "BLOK 10",
        "headers": ["Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     1167,   "",     "",     "",     "",     "",     ""  ], # T9 (Atas)
            ["",     "",     "",     1186,   "",     1156,   "",     "",     "",     ""  ], # T8
            ["",     "",     1193,   1161,   "",     1110,   1075,   1072,   1256,   1035], # T7
            ["",     "",     1190,   712,    1053,   1058,   1170,   1189,   1042,   1045], # T6
            ["",     1209,   1159,   488,    1212,   1040,   1049,   716,    1044,   714 ], # T5
            ["",     1174,   739,    728,    1205,   889,    877,    344,    428,    717 ], # T4
            ["",     265,    338,    385,    609,    597,    420,    358,    50,     406 ], # T3
            [1202,   434,    341,    323,    607,    586,    400,    390,    328,    366 ], # T2
            [1169,   90,     721,    720,    610,    590,    421,    351,    255,    392 ], # T1 (Dasar)
        ]
    },
    11: {
        "title": "BLOK 11",
        ...
        "data": [
            ["",     "",     "",     "",     1207,   "",     "",     "",     "",     ""  ], # T10 (Atas)
            ["",     "",     "",     "",     1052,   "",     1183,   "",     "",     ""  ], # T9
            ["",     "",     1208,   1197,   1180,   1173,   1109,   "",     "",     ""  ], # T8
            ["",     1181,   1149,   1198,   1096,   1094,   1030,   1108,   1055,   1093], # T7
            ["",     1182,   1157,   1165,   733,    732,    743,    768,    769,    885 ], # T6
            ["",     1060,   1119,   1098,   738,    734,    735,    737,    770,    767 ], # T5
            ["",     605,    729,    713,    611,    587,    247,    414,    346,    764 ], # T4
            [1192,   689,    396,    278,    513,    565,    154,    505,    259,    228 ], # T3
            [1179,   337,    331,    393,    598,    567,    422,    347,    327,    355 ], # T2
            [1056,   415,    333,    254,    596,    534,    289,    410,    357,    404 ], # T1 (Dasar)
        ]
    },
    12: {
        "title": "BLOK 12",
        "headers": ["Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",     "",     "",     "",     "",     "",     1104,   1054,   1050,   ""  ], # T10 (Atas)
            ["",     "",     "",     "",     "",     1214,   1103,   1029,   1031,   1027], # T9
            ["",     "",     "",     "",     1203,   873,    880,    881,    891,    1020], # T8
            ["",     "",     1199,   1213,   886,    884,    895,    887,    888,    892 ], # T7
            ["",     1217,   1176,   1191,   747,    787,    748,    788,    762,    765 ], # T6
            ["",     1215,   1059,   1048,   715,    786,    789,    763,    761,    766 ], # T5
            [1188,   730,    1016,   718,    517,    208,    342,    169,    216,    459 ], # T4
            [1195,   324,    731,    741,    519,    529,    445,    403,    361,    455 ], # T3
            [1162,   700,    383,    707,    30,     528,    312,    316,    407,    231 ], # T2
            [1115,   321,    726,    722,    512,    545,    394,    322,    335,    264 ], # T1 (Dasar)
        ]
    },
    13: {
        "title": "BLOK 13",
        ...
        "data": [
            ["",     "",     "",     "",     1184,   "",     "",     "",     "",     1150], # T10 (Atas)
            ["",     1112,   "",     1172,   1148,   1164,   1223,   1141,   1021,   1126], # T9
            ["",     1201,   "",     1143,   874,    1151,   868,    861,    833,    866 ], # T8
            ["",     1006,   1168,   1194,   862,    869,    863,    872,    870,    875 ], # T7
            ["",     1012,   1206,   1005,   752,    751,    771,    772,    757,    759 ], # T6
            ["",     997,    1014,   379,    773,    755,    753,    749,    756,    758 ], # T5
            ["",     424,    197,    369,    535,    531,    63,     168,    372,    402 ], # T4
            [1142,   699,    426,    271,    527,    533,    233,    461,    446,    132 ], # T3
            [1019,   725,    702,    722,    126,    16,     140,    141,    178,    401 ], # T2
            [1029,   275,    325,    613,    "08",   541,    173,    409,    442,    429 ], # T1 (Dasar)
        ]
    },
    14: {
        "title": "BLOK 14",
        ...
        "data": [
            ["",     "",     "",     "",     "",     "",     "",     "",     "",     1023], # T10 (Atas)
            ["",     "",     "",     "",     1107,   1127,   1140,   "",     1117,   1125], # T9
            [1136,   1120,   1154,   "",     1116,   860,    882,    1106,   839,    825 ], # T8
            [998,    1009,   1196,   "",     893,    858,    883,    879,    857,    820 ], # T7
            [1011,   990,    1008,   "",     796,    792,    797,    807,    798,    801 ], # T6
            [835,    836,    1015,   "",     791,    795,    790,    802,    800,    760 ], # T5
            [419,    382,    840,    "",     532,    571,    273,    449,    441,    181 ], # T4
            [701,    340,    425,    "",     482,    13,     219,    232,    454,    457 ], # T3
            [591,    599,    267,    683,    526,    308,    49,     411,    319,    452 ], # T2
            [614,    622,    709,    1185,   522,    543,    450,    256,    376,    175 ], # T1 (Dasar)
        ]
    },
    15: {
        "title": "BLOK 15",
        ...
        "data": [
            ["",     "",     "",     "",     1138,   1100,   "",     "",     "",     ""  ], # T9 (Atas)
            [1121,   "",     1155,   "",     1131,   1132,   1146,   812,    "",     1137], # T8
            [999,    1144,   1018,   "",     823,    831,    838,    837,    818,    1111], # T7
            [995,    1000,   1007,   "",     814,    817,    845,    855,    854,    793 ], # T6
            [821,    1017,   1003,   "",     810,    816,    849,    856,    853,    794 ], # T5
            [418,    841,    832,    "",     525,    537,    276,    564,    149,    443 ], # T4
            [592,    727,    724,    "",     521,    536,    575,    223,    220,    435 ], # T3
            [705,    595,    604,    1124,   481,    566,    559,    572,    356,    285 ], # T2
            [621,    692,    711,    1128,   "03",   553,    179,    574,    150,    343 ], # T1 (Dasar)
        ]
    },
    16: {
        "title": "BLOK 16",
        ...
        "data": [
            ["",     "",     "",     "",     1123,   "",     "",     "",     "",     ""  ], # T10 (Atas)
            ["",     "",     "",     "",     1134,   "",     1211,   "",     1113,   1133], # T9
            [1145,   1153,   1166,   "",     878,    "",     842,    1177,   1122,   1139], # T8
            [992,    1004,   991,    "",     994,    1147,   843,    834,    808,    813 ], # T7
            [1010,   996,    1001,   "",     828,    809,    811,    847,    848,    852 ], # T6
            [878,    1013,   822,    "",     827,    819,    846,    844,    851,    850 ], # T5
            [698,    876,    824,    "",     113,    552,    555,    558,    549,    307 ], # T4
            [588,    603,    588,    "",     480,    548,    542,    557,    544,    561 ], # T3
            [623,    815,    612,    1135,   523,    539,    547,    554,    540,    538 ], # T2
            [706,    708,    704,    1160,   524,    551,    546,    573,    64,     560 ], # T1 (Dasar)
        ]
    },
}
