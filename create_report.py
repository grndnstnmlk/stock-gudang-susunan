...
blocks_data = {
    1: {
        ...
        "data": [
            ...
            ["",   "",   921,  "",   "",   "",   305, 18,  520, 144, 234, 274], # T4
            [116,  900,  864,  620,  1363, "",   508, 214, 460, 462, 516, 123], # T3
            [901,  926,  923,  318,  915,  "",   283, 23,  467, 509, 177, 193], # T2
    ...
    2: {
        ...
        "data": [
            ...
            ["",   "",   917,  "",   "",   "",   125, 444, 158, 448, 108, 112], # T4
            [932,  924,  631,  920,  1355, "",   493, 439, 438, 511, 171, 124], # T3
            [902,  919,  703,  916,  912,  "",   183, 368, 464, 491, 469, 504], # T2
    ...
    3: {
        ...
        "data": [
            ...
            [934,  936,    937,    1354,   1358,   "",     180, 473, 432, 456, 282, 91 ], # T3
            [913,  933,    939,    935,    922,    "",     222, 217, 502, 440, 487, "" ], # T2
    ...
    4: {
        ...
        "data": [
            ...
            [1307,   1289,   1303,   1316,   1365,   "",     279, 451, 442, 513, 461, 459], # T2
    ...
    5: {
        ...
        "data": [
            ...
            [1386,   1315,   1331,   1305,   1308,   "",     284, 216, 219, 498, 430, 472], # T2
    ...
    6: {
        ...
        "data": [
            ...
            [1314,   1311,   "",     "",     1361,   "",     505, 501, 429, 500, 499, 517], # T3
            [1321,   1291,   1283,   1318,   1317,   "",     476, 480, 479, 478, 477, 518], # T2
    ...
    7: {
        ...
        "data": [
            ...
            [1168,   1388,   1322,   1285,   1304,   "",     619, 600, 377, 326, 339, 375], # T2
