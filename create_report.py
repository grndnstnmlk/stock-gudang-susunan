...
blocks_data = {
    ...
    10: {
        ...
        "data": [
            ["",   "",   "",   "",   "",   "",   "",   "",   1035], # T9 (Atas)
            ["",   "",   "",   "",   "",   "",   "",   "",   1042], # T8
            ["",   "",   "",   "",   1044, "",   1023, 1037, 1041], # T7
            ["",   "",   712,  "",   1045, 1030, 1039, 1022, 714], # T6
            ["",   "",   488,  "",   889,  1040, 716,  1027, 717], # T5
            ["",   739,  728,  "",   597,  877,  344,  428,  470], # T4
            [265,  338,  385,  609,  586,  420,  358,  50,   406], # T3
            [434,  341,  323,  607,  590,  400,  390,  328,  366], # T2
            [90,   721,  720,  610,  "",   421,  351,  255,  392], # T1 (Dasar)
        ]
    },
    11: {
        "title": "BLOK 11",
        ...
        "data": [
            ["",   "",   "",   "",   "",   "",   "",   "",   1026], # T9 (Atas)
            ["",   "",   "",   "",   "",   1038, 1021, 1028, 1034], # T8
            ["",   "",   "",   "",   "",   1025, 1036, 1024, 885], # T7
            ["",   "",   "",   733,  732,  743,  768,  769,  767], # T6
            ["",   "",   "",   738,  734,  735,  737,  770,  764], # T5
            [605,  729,  713,  611,  587,  247,  414,  346,  "" ], # T4
            [689,  396,  278,  513,  565,  154,  505,  259,  228], # T3
            [337,  331,  393,  598,  567,  422,  347,  327,  355], # T2
            [415,  333,  254,  596,  534,  289,  410,  357,  404], # T1 (Dasar)
        ]
    },
    12: {
        "title": "BLOK 12",
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",   "",   "",   "",   "",   "",   1043, 1033, 1023], # T10 (Atas)
            ["",   "",   "",   "",   "",   1046, 1029, 1031, 1020], # T9
            ["",   "",   "",   894,  873,  880,  881,  891,  892], # T8
            ["",   "",   "",   886,  884,  895,  887,  888,  "" ], # T7
            ["",   "",   "",   747,  787,  748,  788,  762,  765], # T6
            ["",   "",   "",   715,  786,  789,  763,  761,  766], # T5
            [730,  1016, 718,  517,  208,  342,  169,  216,  459], # T4
            [324,  731,  741,  519,  529,  445,  403,  361,  455], # T3
            [700,  383,  707,  30,   528,  312,  316,  407,  231], # T2
            [321,  726,  722,  512,  545,  394,  322,  335,  264], # T1 (Dasar)
        ]
    },
    13: {
        "title": "BLOK 13",
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",   "",   "",   874,  "",   868,  861,  833,  866], # T8 (Atas)
            [1019, "",   "",   862,  869,  863,  872,  870,  875], # T7
            [1012, 1006, 1005, 752,  751,  771,  772,  757,  759], # T6
            [997,  1014, 379,  773,  755,  753,  749,  756,  758], # T5
            [424,  197,  369,  535,  531,  63,   168,  372,  402], # T4
            [699,  426,  271,  527,  533,  233,  461,  446,  132], # T3
            [725,  702,  722,  126,  16,   140,  141,  178,  401], # T2
            [275,  325,  613,  "08", 541,  173,  409,  442,  429], # T1 (Dasar)
        ]
    },
    14: {
        "title": "BLOK 14",
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",   "",   "",   "",   890,  860,  882,  "",   825], # T8 (Atas)
            [998,  1009, "",   893,  858,  883,  879,  857,  820], # T7
            ...
            [591,  599,  267,  526,  308,  49,   411,  319,  452], # T2
            [614,  622,  709,  522,  543,  450,  256,  376,  175], # T1 (Dasar)
        ]
    },
    15: {
        "title": "BLOK 15",
        ...
        "data": [
            ["",   "",   "",   "",   "",   "",   "",   "",   "" ], # T8 (Atas)
            [999,  "",   1018, 823,  831,  838,  837,  818,  812], # T7
            ...
            [705,  595,  604,  481,  566,  559,  572,  356,  285], # T2
            [621,  692,  711,  "03", 553,  179,  574,  150,  343], # T1 (Dasar)
        ]
    },
    16: {
        "title": "BLOK 16",
        ...
        "data": [
            ["",   "",   "",   878,  "",   "",   "",   "",   839], # T8 (Atas)
            [992,  1004, 991,  994,  842,  843,  834,  808,  813], # T7
            ...
            [623,  815,  612,  523,  539,  547,  554,  540,  538], # T2
            [706,  708,  704,  524,  551,  546,  573,  64,   560], # T1 (Dasar)
        ]
    },
}
