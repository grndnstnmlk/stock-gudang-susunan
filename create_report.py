...
blocks_data = {
    ...
    12: {
        ...
        "data": [
            ...
            ["",   "",   "",   886,  884,  895,  887,  888,  877], # T7
            ["",   "",   "",   747,  787,  748,  788,  762,  765], # T6
            ["",   "",   "",   715,  786,  789,  763,  761,  766], # T5
            [730,  "",   718,  517,  208,  342,  169,  216,  459], # T4
    ...
    13: {
        ...
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",   "",   "",   874,  878,  868,  861,  833,  866], # T8 (Atas)
            ["",   "",   "",   862,  869,  863,  872,  870,  875], # T7
            ["",   "",   "",   752,  751,  771,  772,  757,  759], # T6
            ["",   "",   379,  773,  755,  753,  749,  756,  758], # T5
            [424,  167,  369,  535,  531,  63,   168,  372,  402], # T4
    ...
    14: {
        ...
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",   "",   "",   876,  890,  860,  882,  "",   825], # T8 (Atas)
            ["",   "",   "",   893,  858,  883,  879,  857,  820], # T7
            ["",   "",   "",   796,  792,  797,  807,  798,  801], # T6
            ["",   "",   "",   791,  795,  790,  802,  800,  760], # T5
            [419,  382,  "",   532,  571,  273,  449,  441,  181], # T4
    ...
    16: {
        ...
        "data": [
            ...
            [698,  "",   "",   113,  552,  555,  558,  549,  307], # T4
