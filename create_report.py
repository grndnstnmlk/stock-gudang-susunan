...
blocks_data = {
    1: {
        ...
        "data": [
            ...
            [859, 865, 914, 494, 497, 453, 474, 116, 310], # T1 (Dasar)
        ]
    },
    2: {
        "title": "BLOK 02",
        "headers": ["Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ["",  "",   "",   634, "",  646, 648, 645, 602], # T6 (Atas)
            ["",  "",   "",   289, 633, 649, 641, 601, 642], # T5
            ["",  106, 318, 125, 444, 158, 448, 108, 112], # T4
            ["",  703, "",   493, 439, 438, 511, 171, 124], # T3
            [913, 631, 912, 183, 368, 464, 491, 469, 504], # T2
            [593, "",   899, 164, 288, 510, 227, 416, 99 ], # T1 (Dasar)
        ]
    },
    3: {
        "title": "BLOK 03",
    ...
    7: {
        ...
        "data": [
            ...
            [616, 606, "",  427, 395, 311], # T4 (318 dipindah ke Blok 2 Saf -1 T4)
            [617, "",  380, 350, 330, 329], # T3 (593 dipindah ke Blok 2 Saf -3 T1)
    ...
    8: {
        ...
        "data": [
            ...
            [706, 705, 698, 699, "",  689], # T5 (703 dipindah ke Blok 2 Saf -2 T3)
