...
blocks_data = {
    ...
    9: {
        ...
        "headers": ["Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            [704, "",  724, 725, 726, 721], # T6 (Atas)
            [708, 692, 727, 723, 722, 720], # T5
            [622, 595, 418, 426, 337, 323], # T4
    ...
    10: {
        ...
        "headers": ["Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            [728, 739, 731, 718, 712, 714], # T6 (Atas)
            [730, 741, 729, 716, 713, 717], # T5
    ...
    11: {
        ...
        "data": [
            ...
            [611, 587, 247, 414, 346, 338], # T4
            [513, 565, 154, 505, 259, 228], # T3
    ...
    13: {
        ...
        "data": [
            ...
            [773, 755, 753, 749, 756, 758], # T5
            [535, 531, 63,  168, 372, 402], # T4
