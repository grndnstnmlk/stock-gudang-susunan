...
blocks_data = {
    1: {
        ...
        "data": [
            ...
            [1556,   1581,   "",     1491,   1451,   "",     24,  182, 132, 635, 636, 639], # T5
            [1474,   1471,   1476,   1427,   1396,   "",     305, 18,  520, 144, 234, 274], # T4
            [116,    900,    864,    620,    1363,   "",     508, 214, 460, 462, 516, 123], # T3
    ...
    2: {
        ...
        "data": [
            ...
            ["",     "",     1351,   "",     "",     "",     634, 631, 646, 648, 645, 602], # T6
    ...
    3: {
        ...
        "data": [
            ...
            ["",     "",     "",     "",     "",     "",     625, 608, 627, 628, 652, 661], # T6
            [1572,   "",     "",     "",     1490,   "",     632, 626, 629, 630, 657, 655], # T5
            [1460,   "",     "",     1414,   1445,   "",     230, 199, 503, 495, 32,  437], # T4
    ...
    4: {
        ...
        "data": [
            ...
            ["",     1436,   1399,   1417,   1446,   "",     166, 466, 178, 215, 307, 309], # T3
    ...
    6: {
        ...
        "data": [
            ["",     "",     "",     "",     "",     "",     "",     1398,   "",     "",     "",     ""   ], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     1485,   1380,   1299,   "",     "",     ""   ], # T7
            ["",     "",     "",     "",     "",     "",     1382,   1394,   1478,   1505,   "",     ""   ], # T6
            [1583,   1313,   "",     1555,   "",     1550,   1459,   1513,   1516,   1504,   1502,   1528 ], # T5
    ...
    7: {
        ...
        "data": [
            ["",     "",     "",     "",     "",     "",     "",     1381,   "",     "",     "",     ""   ], # T8 (Atas)
            ["",     "",     "",     "",     "",     "",     "",     1295,   "",     "",     "",     ""   ], # T7
            [1544,   1570,   1554,   1582,   "",     "",     1384,   1387,   1290,   1515,   "",     ""   ], # T6
            [1453,   1479,   1495,   1488,   1573,   "",     1373,   1395,   1264,   1523,   1527,   1526 ], # T5
    ...
    8: {
        ...
        "data": [
            [1553,   "",     "",     "",     "",     "",     "",     "",     "",     "",     "",     ""   ], # T9 (Atas)
            [1568,   "",     "",     "",     "",     "",     "",     "",     "",     "",     "",     ""   ], # T8
            [1541,   1557,   "",     "",     1585,   "",     1481,   1377,   "",     "",     "",     ""   ], # T7
            [1353,   1542,   1567,   1494,   1540,   "",     1378,   1372,   1306,   1531,   1498,   1520 ], # T6
            [1424,   1480,   1543,   1412,   1383,   "",     1461,   1265,   1320,   1621,   1533,   1518 ], # T5
