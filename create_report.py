...
blocks_data = {
    ...
    10: {
        ...
        "data": [
            ...
            ["",     "",     "",     1186,   "",     "",     "",     "",     "",     ""  ], # T8
            ["",     "",     "",     1161,   "",     1110,   "",     "",     "",     1035], # T7
            ["",     "",     1190,   712,    1053,   1058,   1049,   1039,   1042,   1045], # T6
            ["",     1209,   1159,   488,    1212,   1040,   470,    716,    1044,   714 ], # T5
    ...
    11: {
        ...
        "data": [
            ["",     "",     "",     "",     1052,   "",     "",     "",     "",     ""  ], # T9 (Atas)
            ["",     "",     "",     "",     1180,   "",     1109,   "",     "",     ""  ], # T8
            ["",     1182,   "",     1198,   1096,   1094,   1030,   1108,   1055,   1093], # T7
            ["",     1060,   1149,   1165,   733,    732,    743,    768,    769,    885 ], # T6
            ["",     1119,   1157,   1098,   738,    734,    735,    737,    770,    767 ], # T5
            ["",     605,    729,    713,    611,    587,    247,    414,    346,    764 ], # T4
            ["",     689,    396,    278,    513,    565,    154,    505,    259,    228 ], # T3
    ...
    12: {
        ...
        "data": [
            ...
            ["",     "",     "",     "",     886,    884,    895,    887,    888,    892 ], # T7
            ["",     "",     1176,   1191,   747,    787,    748,    788,    762,    765 ], # T6
            ["",     1215,   1059,   1048,   715,    786,    789,    763,    761,    766 ], # T5
            ["",     730,    1016,   718,    517,    208,    342,    169,    216,    459 ], # T4
            ["",     324,    731,    741,    519,    529,    445,    403,    361,    455 ], # T3
