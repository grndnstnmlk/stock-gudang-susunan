...
blocks_data = {
    1: {
        "title": "BLOK 01",
        "headers": ["Saf -5", "Saf -4", "Saf -3", "Saf -2", "Saf -1", "Saf 1", "Saf 2", "Saf 3", "Saf 4", "Saf 5", "Saf 6"],
        "data": [
            ...
            [116,  900,  864,  620,  "",   508, 214, 460, 462, 516, 123], # T3
            [901,  926,  923,  318,  915,  283, 23,  467, 509, 177, 193], # T2
            [107,  594,  859,  865,  914,  494, 497, 453, 474, "",  310], # T1 (Dasar)
        ]
    },
    2: {
        "title": "BLOK 02",
        ...
        "data": [
            ...
            [932,  924,  631,  920,  "",   493, 439, 438, 511, 171, 124], # T3
            [902,  919,  703,  916,  912,  183, 368, 464, 491, 469, 504], # T2
            [927,  928,  593,  871,  899,  164, 288, 510, 227, 416, 99 ], # T1 (Dasar)
        ]
    },
    3: {
        "title": "BLOK 03",
        ...
        "data": [
            ...
            ["",   1272,   1261,   "",     "",     230, 199, 503, 495, 32,  437], # T4
            [934,  936,    937,    1266,   1267,   180, 473, 432, 456, 282, 91 ], # T3
            [913,  933,    939,    935,    922,    222, 217, 502, 440, 487, "" ], # T2
            [929,  590,    925,    938,    918,    408, 465, 296, 421, 463, 206], # T1 (Dasar)
        ]
    },
    4: {
        "title": "BLOK 04",
        ...
        "data": [
            ...
            [1273,   1269,   1263,   1262,   1268,   304, 452, 458, 450, 449, 496], # T1 (Dasar)
        ]
    },
    5: {
        "title": "BLOK 05",
        ...
        "data": [
            ...
            [1271,   1260,   1270,   1258,   1259,   306, 229, 218, 454, 455, 486], # T1 (Dasar)
        ]
    },
    6: {
        "title": "BLOK 06",
        ...
        "data": [
            ...
            [1160,   "",     "",     "",     "",     476, 480, 479, 478, 477, 518], # T2
            [1171,   1282,   1275,   1280,   1152,   481, 482, 483, 475, 360, 447], # T1 (Dasar)
        ]
    },
    7: {
        "title": "BLOK 07",
        ...
        "data": [
            ...
            [1281,   1092,   1126,   1216,   "",     619, 600, 377, 326, 339, 375], # T2
            [1274,   1279,   1278,   1276,   1277,   618, 589, 320, 384, 371, 352], # T1 (Dasar)
        ]
    },
    8: {
        "title": "BLOK 08",
